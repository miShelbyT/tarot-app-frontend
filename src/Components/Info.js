...
function Info() {
  ...
  return (
    ...
    <div className="card-container learn-more">
      ...
      <p>Each Drawn card will represent a different aspect of you, your life, or the situation you are asking about. In our app the meanings are as follows:</p>
      <ul>
        <li>
          The First card represents the energy around the current situation or person you are asking about
                </li>
        <li>
          The second card represents past events that have led to the current situation
                </li>
        <li>
          The third card represents events or energy that the future holds if things continue as they are
                </li>
        <li>
          The fourth card represents the most dominant thoughts and energy in your conscious mind and how they may affect the situation
                </li>
        <li>
          The fifth card represents subconscious thoughts and energy that drive the situation, in someties unexpected ways

                </li>

      </ul>
      <p>Keep in mind that tarot cards are a good tool to look at a situation in a different light, to analyze your thoughts, conscious and subconscious, and reflect upon the predicaments and situations you may find yourself in. It is a fun and insightful tool at your disposal to be used as you see fit. Most importantly, you should have fun and enjoy the time to reflect.</p>
      <p>For more information please visit our friends at  <a href="https://www.mindbodygreen.com/0-18172/how-to-do-a-basic-tarot-reading-for-yourself-or-a-friend.html">mindbodygreen</a> and <a href="https://everybodymind.com/7-things-youd-want-to-know-about-tarot-reading/">everybodymind</a></p>
    </div>
  )
